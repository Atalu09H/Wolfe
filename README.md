...
تابع cg_default تمام پارامترهای پیش‌فرض مورد نیاز برای الگوریتم گرادیان مزدوج (Conjugate Gradient) و جستجوی خطی Wolfe را مقداردهی اولیه می‌کند.
...
> خروجی این تابع معادل با `xtemp[:] = x + alpha * d` است### تابع `cg_step`
